...
export const ProductData = async()=>{
  const res = await client.fetch(`*[_type == "saleproducts"  ]{
    price,
    _id,
    title,
    image,
...
const SaleTshirts = async () => {
  ...
  return (
    ...
    <div className='text-center mt-[100px] flex flex-col'>
      ...
      <h1 className='text-4xl font-bold mt-1 '>On Sale T-Shirts</h1>
      </div>
      <div className='flex justify-center  gap-x-1 md:gap-x-5   flex-col sm:flex-row items-center'>
      {
